...
while True:
    ...
    if (anom1[0] > lock1[0] - size*10) and (anom1[0] < lock1[0] + size*10) and (anom1[1] > lock1[1] - size*10) and (anom1[1] < lock1[1] + size*10):
    ...
    if (anom1[0] > lock2[0] - size*10) and (anom1[0] < lock2[0] + size*10) and (anom1[1] > lock2[1] - size*10) and (anom1[1] < lock2[1] + size*10):

        tl1 = font.render(('(№ аномалии 1)'), True, pygame.Color('darkorange'))
        surf.blit(tl1, (1400, 350))
        pygame.draw.rect(sc, pygame.Color('red'), (*anom1, size, size))

    if (anom1[0] > lock3[0] - size*10) and (anom1[0] < lock3[0] + size*10) and (anom1[1] > lock3[1] - size*10) and (anom1[1] < lock3[1] + size*10):
    ...
    if (anom2[0] > lock1[0] - size * 10) and (anom2[0] < lock1[0] + size * 10) and (
            anom2[1] > lock1[1] - size * 10) and (anom2[1] < lock1[1] + size * 10):
    ...
    if (anom2[0] > lock2[0] - size * 10) and (anom2[0] < lock2[0] + size * 10) and (
            anom2[1] > lock2[1] - size * 10) and (anom2[1] < lock2[1] + size * 10):
        tl1 = font.render(('(№ аномалии 2)'), True, pygame.Color('darkorange'))
        surf.blit(tl1, (1400, 370))
        pygame.draw.rect(sc, pygame.Color('red'), (*anom2, size, size))

    if (anom2[0] > lock3[0] - size * 10) and (anom2[0] < lock3[0] + size * 10) and (
            anom2[1] > lock3[1] - size * 10) and (anom2[1] < lock3[1] + size * 10):
        tl1 = font.render(('(№ аномалии 2)'), True, pygame.Color('darkorange'))
    ...
    if (anom3[0] > lock1[0] - size * 10) and (anom3[0] < lock1[0] + size * 10) and (
            anom3[1] > lock1[1] - size * 10) and (anom3[1] < lock1[1] + size * 10):
    ...
    if (anom3[0] > lock2[0] - size * 10) and (anom3[0] < lock2[0] + size * 10) and (
            anom3[1] > lock2[1] - size * 10) and (anom3[1] < lock2[1] + size * 10):
        tl1 = font.render(('(№ аномалии 3)'), True, pygame.Color('darkorange'))
        surf.blit(tl1, (1400, 390))
        pygame.draw.rect(sc, pygame.Color('red'), (*anom3, size, size))

    if (anom3[0] > lock3[0] - size * 10) and (anom3[0] < lock3[0] + size * 10) and (
            anom3[1] > lock3[1] - size * 10) and (anom3[1] < lock3[1] + size * 10):
        tl1 = font.render(('(№ аномалии 3)'), True, pygame.Color('darkorange'))
    ...
    if (anom4[0] > lock1[0] - size * 10) and (anom4[0] < lock1[0] + size * 10) and (
            anom4[1] > lock1[1] - size * 10) and (anom4[1] < lock1[1] + size * 10):
    ...
    if (anom4[0] > lock2[0] - size * 10) and (anom4[0] < lock2[0] + size * 10) and (
            anom4[1] > lock2[1] - size * 10) and (anom4[1] < lock2[1] + size * 10):
        tl1 = font.render(('(№ аномалии 4)'), True, pygame.Color('darkorange'))
        surf.blit(tl1, (1400, 410))
        pygame.draw.rect(sc, pygame.Color('red'), (*anom4, size, size))

    if (anom4[0] > lock3[0] - size * 10) and (anom4[0] < lock3[0] + size * 10) and (
            anom4[1] > lock3[1] - size * 10) and (anom4[1] < lock3[1] + size * 10):
        tl1 = font.render(('(№ аномалии 4)'), True, pygame.Color('darkorange'))
    ...
    if (anom5[0] > lock1[0] - size * 10) and (anom5[0] < lock1[0] + size * 10) and (
            anom5[1] > lock1[1] - size * 10) and (anom5[1] < lock1[1] + size * 10):
    ...
    if (anom5[0] > lock2[0] - size * 10) and (anom5[0] < lock2[0] + size * 10) and (
            anom5[1] > lock2[1] - size * 10) and (anom5[1] < lock2[1] + size * 10):
        tl1 = font.render(('(№ аномалии 5)'), True, pygame.Color('darkorange'))
        surf.blit(tl1, (1400, 430))
        pygame.draw.rect(sc, pygame.Color('red'), (*anom5, size, size))

    if (anom5[0] > lock3[0] - size * 10) and (anom5[0] < lock3[0] + size * 10) and (
            anom5[1] > lock3[1] - size * 10) and (anom5[1] < lock3[1] + size * 10):
        tl1 = font.render(('(№ аномалии 5)'), True, pygame.Color('darkorange'))
