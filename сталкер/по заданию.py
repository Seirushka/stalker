...
#print(grid)
#grid = [[1 if ((col == anom1[0]/TILE and row == anom1[1]/TILE) or (col == anom2[0]/TILE and row == anom2[1]/TILE) or (col == anom3[0]/TILE and row == anom3[1]/TILE) or (col == anom4[0]/TILE and row == anom4[1]/TILE) or (col == anom5[0]/TILE and row == anom5[1]/TILE)) else 0 for col in range(cols)] for row in range(rows)]
...
while True:
    ...
    #if (x == anom1[0] and y == anom1[1]) or (x == anom2[0] and y== anom2[1]) or (x == anom3[0] and y== anom3[1]) or (x == anom4[0] and y== anom4[1]) or (x == anom5[0] and y== anom5[1]):
    #    print(x, y)
    #    break
