...
im = pygame.image.load('visual/map.png')  # слово сталкер не нужно если открываешь фаил в пустой рабочей среде
...
# локаторы
l1 = pygame.image.load('visual/n.png')
l2 = pygame.image.load('visual/n2.png')
l3 = pygame.image.load('visual/n3.png')
